...
!((e) => {
	...
	var o = !1,
		...
		h =
			...
			!1;
	if (u) a.cancelAnimationFrame || (h = (_e) => {});
	else {
		var p = 0;
		(u = (e, _o) => {
	...
	var m = a.MutationObserver || a.WebKitMutationObserver || !1,
		...
		b = function (e, p) {
			...
			function b() {
				...
				for (; e.length > 0; ) {
					...
					var o = e.css("zIndex");
					if (!Number.isNaN(o) && 0 !== o) return parseInt(o, 10);
					e = e.parent();
				}
				return !1;
			}
			...
			function z(e, o, t, r) {
				...
				if (
					...
					var s = e > 0 ? 1 : -1;
					X !== s &&
						(T.scrollmom?.stop(), (T.newscrollx = T.getScrollLeft()), (X = s)),
						(T.lastdeltax -= e);
				}
				if (o) {
					if (
					...
					var l = o > 0 ? 1 : -1;
					B !== l &&
						(T.scrollmom?.stop(), (T.newscrolly = T.getScrollTop()), (B = l)),
						(T.lastdeltay -= o);
				}
				(o || e) &&
			...
			if (
				...
				(this.doc = M.doc),
				(this.iddoc = this.doc?.[0] ? this.doc[0].id || "" : ""),
			...
			(this.canhwscroll = P.hastransform && M.hwacceleration),
				...
				(this.synched = (e, o) => {
					T.synclist[e]
						...
						: ((T.synclist[e] = o),
							u(() => {
								T && (T.synclist[e]?.call(T), (T.synclist[e] = null));
							}));
				}),
				(this.unsynched = (e) => {
				...
				(this.scrollTop = (e) =>
					void 0 === e ? T.getScrollTop() : T.setScrollTop(e)),
				(this.scrollLeft = (e) =>
					void 0 === e ? T.getScrollLeft() : T.setScrollLeft(e));
			...
			if (
				...
				(this.doc.translate = { x: 0, y: 0, tx: "0px", ty: "0px" }),
					...
					(this.getScrollTop = (e) => {
						if (!e) {
							...
							if (T.timerscroll?.bz) return T.timerscroll.bz.getNow();
						}
					...
					(this.getScrollLeft = (e) => {
						if (!e) {
							...
							if (T.timerscroll?.bh) return T.timerscroll.bh.getNow();
						}
						return T.doc.translate.x;
					}),
					(this.notifyScrollEvent = (e) => {
				...
				(this.getScrollTop = () => T.docscroll.scrollTop()),
					(this.setScrollTop = (e) => {
			...
			(this.getDocumentScrollOffset = () => ({
					...
					if (
						...
						if (
							...
							(T.hasTextSelected =
								"getSelection" in l
									...
									: "selection" in l
										? () => "None" !== l.selection.type
										: () => !1),
								(T.onselectionstart = (_e) => {
						...
						if (
							(P.hasw3ctouch
								...
								: P.hasmstouch
									? (T.css(T.ispage ? n("html") : T.win, {
										...
										T.bind(T.cursor, "MSGestureHold", (e) => {
											e.preventDefault();
										}),
										T.bind(T.cursor, "contextmenu", (e) => {
											e.preventDefault();
										}))
									: P.cantouch &&
							...
							(M.cursordragontouch || (!P.cantouch && !M.emulatetouch)) &&
								...
								M.sensitiverail &&
									(T.bind(T.rail, "click", (e) => {
										T.doRailClick(e, !1, !1);
									}),
									T.bind(T.rail, "dblclick", (e) => {
										T.doRailClick(e, !0, !1);
									}),
									T.bind(T.cursor, "click", (e) => {
										T.cancelEvent(e);
									}),
									T.bind(T.cursor, "dblclick", (e) => {
										T.cancelEvent(e);
									})),
								T.railh &&
									(T.jqbind(T.railh, "mouseenter", () => {
										if (!T.ispage && !T.win.is(":visible")) return !1;
									...
									M.sensitiverail &&
										(T.bind(T.railh, "click", (e) => {
											T.doRailClick(e, !1, !0);
										}),
										T.bind(T.railh, "dblclick", (e) => {
											T.doRailClick(e, !0, !0);
										}),
										T.bind(T.cursorh, "click", (e) => {
											T.cancelEvent(e);
										}),
										T.bind(T.cursorh, "dblclick", (e) => {
											T.cancelEvent(e);
										})))),
							M.cursordragontouch &&
								...
								? (T.bind(
									...
									M.cursordragontouch
										? (T.bind(T.cursor, "mousedown", T.onmousedown),
											...
											T.cursorh &&
												T.bind(T.cursorh, "mousedown", (e) => {
													T.onmousedown(e, !0);
												}),
											T.cursorh && T.bind(T.cursorh, "mouseup", T.onmouseup))
										: (T.bind(T.rail, "mousedown", (e) => {
												e.preventDefault();
											}),
											T.railh &&
												T.bind(T.railh, "mousedown", (e) => {
													e.preventDefault();
												})))
								: (T.bind(
										P.hasmousecapture ? T.win : l,
						...
						if (
							((T.onAttributeChange = (_e) => {
								T.lazyResize(T.isieold ? 250 : 30);
							}),
							M.enableobserver &&
								(T.isie11 ||
									!1 === m ||
									((T.observerbody = new m((e) => {
										if (
											(e.forEach((e) => {
							...
							T.lazyResize(30),
								...
								P.cantouch
									...
									: M.emulatetouch &&
										...
										T.bind(o, "mousemove", (e) => T.ontouchmove(e, !0)),
										M.grabcursorenabled &&
											P.cursorgrabvalue &&
				...
				(this.getContentSize = T.ispage
					...
					: T.haswrapper
						? () => ({ w: T.doc[0].offsetWidth, h: T.doc[0].offsetHeight })
						: () => ({
			...
			if (P.haseventlistener) {
				...
				(Event.prototype.preventDefault = function () {
					...
					(this.stopPropagation = (e) => (
						(e = e || a.event) && (e.cancelBubble = !0), !1
					));
			(this.delegate = (e, o, t, r, i) => {
				var s = d[o] || !1;
				s ||
					((s = {
						a: [],
				...
				(this.showRails = () => T.showRail().showRailHr()),
				(this.showRail = () => (
					0 === T.page.maxh ||
				...
				(this.hideRails = () => T.hideRail().hideRailHr()),
				(this.hideRail = () => (
				...
				(this.show = () => (
					(T.hidden = !1), (T.railslocked = !1), T.showRails()
				)),
				(this.hide = () => (
					(T.hidden = !0), (T.railslocked = !0), T.hideRails()
				)),
				(this.toggle = () => (T.hidden ? T.show() : T.hide())),
				(this.remove = () => {
				...
				(this.triggerScrollStart = (e, o, t, r, i) => {
					if (T.onscrollstart) {
						var s = {
							type: "scrollstart",
							current: { x: e, y: o },
			...
			if (
				...
				(this.getTransitionSpeed = (e) => (80 + (e / 72) * M.scrollspeed) | 0),
				M.smoothscroll)
			)
				if (
					T.ishwscroll &&
					...
					(this.resetTransition = () => {
						...
						(this.doScrollLeft = (e, o) => {
							var t = T.scrollrunning ? T.newscrolly : T.getScrollTop();
							T.doScrollPos(e, t, o);
						}),
						(this.doScrollTop = (e, o) => {
						...
						(this.cancelScroll = () => {
							...
							return (
								...
								T.timerscroll?.tm && clearInterval(T.timerscroll.tm),
								(T.timerscroll = !1),
								(T.cursorfreezed = !1),
								T.cursorupdate.stop(),
								T.showCursor(e, o),
				...
				(this.doScrollLeft = (e, o) => {
					...
					(this.cancelScroll = () => {});
			(this.doScrollBy = (e, _o) => {
				z(0, e);
			}),
				(this.doScrollLeftBy = (e, _o) => {
					z(e, 0);
				}),
				(this.doScrollTo = (e, o) => {
				...
				(this.doZoom = (e) => (T.zoomactive ? T.doZoomOut(e) : T.doZoomIn(e))),
				(this.resizeZoom = () => {
					if (T.zoomactive) {
						var e = T.getScrollTop();
						T.win.css({
		...
		y = function (e) {
			(this.nc = e),
				...
				(this.update = (e, t) => {
					var r = f();
					(this.steptime = r - this.lasttime), (this.lasttime = r);
					var i = t - this.lasty,
						s = e - this.lastx,
						n = this.nc.getScrollTop() + i,
						l = this.nc.getScrollLeft() + s;
					(this.snapx = l < 0 || l > this.nc.page.maxw),
						(this.snapy = n < 0 || n > this.nc.page.maxh),
						(this.speedx = s),
						(this.speedy = i),
						(this.lastx = e),
						(this.lasty = t);
				...
				(this.stop = () => {
					this.nc.unsynched("domomentum2d"),
				...
				(this.doSnapy = (e, t) => {
					...
					t < 0
						? ((t = 0), (r = !0))
						: t > this.nc.page.maxh && ((t = this.nc.page.maxh), (r = !0)),
						e < 0
							? ((e = 0), (r = !0))
							: e > this.nc.page.maxw && ((e = this.nc.page.maxw), (r = !0)),
						r
							? this.nc.doScrollPos(e, t, this.nc.opt.snapbackspeed)
							: this.nc.triggerScrollEnd();
				}),
				(this.doMomentum = (e) => {
					var t = f(),
						r = e ? t + e : this.lasttime,
						i = this.nc.getScrollLeft(),
						s = this.nc.getScrollTop(),
						n = this.nc.page.maxh,
						l = this.nc.page.maxw;
					(this.speedx = l > 0 ? Math.min(60, this.speedx) : 0),
						(this.speedy = n > 0 ? Math.min(60, this.speedy) : 0);
					var a = r && t - r <= 60;
					(s < 0 || s > n || i < 0 || i > l) && (a = !1);
					var c = !(!this.speedy || !a) && this.speedy,
						d = !(!this.speedx || !a) && this.speedx;
					if (c || d) {
						var u = Math.max(16, this.steptime);
						if (u > 50) {
							var h = u / 50;
							(this.speedx *= h), (this.speedy *= h), (u = 50);
						}
						(this.demulxy = 0),
							(this.lastscrollx = this.nc.getScrollLeft()),
							(this.chkx = this.lastscrollx),
							(this.lastscrolly = this.nc.getScrollTop()),
							(this.chky = this.lastscrolly);
						var p = this.lastscrollx,
							m = this.lastscrolly,
							g = () => {
								var e = f() - t > 600 ? 0.04 : 0.02;
								this.speedx &&
									((p = Math.floor(
										this.lastscrollx - this.speedx * (1 - this.demulxy),
									)),
									(this.lastscrollx = p),
									(p < 0 || p > l) && (e = 0.1)),
									this.speedy &&
										((m = Math.floor(
											this.lastscrolly - this.speedy * (1 - this.demulxy),
										)),
										(this.lastscrolly = m),
										(m < 0 || m > n) && (e = 0.1)),
									(this.demulxy = Math.min(1, this.demulxy + e)),
									this.nc.synched("domomentum2d", () => {
										if (this.speedx) {
											this.nc.getScrollLeft();
											(this.chkx = p), this.nc.setScrollLeft(p);
										}
										if (this.speedy) {
											this.nc.getScrollTop();
											(this.chky = m), this.nc.setScrollTop(m);
										}
										this.timer || (this.nc.hideCursor(), this.doSnapy(p, m));
									}),
									this.demulxy < 1
										? (this.timer = setTimeout(g, u))
										: (this.stop(), this.nc.hideCursor(), this.doSnapy(p, m));
							};
						g();
					} else this.doSnapy(this.nc.getScrollLeft(), this.nc.getScrollTop());
				});
		},
		x = e.fn.scrollTop;
	(e.cssHooks.pageYOffset = {
		get: (e, _o, _t) => {
			...
			return r?.ishwscroll ? r.getScrollTop() : x.call(e);
		},
		set: function (e, o) {
			var t = n.data(e, "__nicescroll") || !1;
			return (
				t?.ishwscroll ? t.setScrollTop(parseInt(o, 10)) : x.call(e, o), this
			);
		},
	}),
		(e.fn.scrollTop = function (e) {
			if (void 0 === e) {
				...
				return o?.ishwscroll ? o.getScrollTop() : x.call(this);
			}
			return this.each(function () {
				var o = n.data(this, "__nicescroll") || !1;
				o?.ishwscroll ? o.setScrollTop(parseInt(e, 10)) : x.call(n(this), e);
			});
		});
	...
	(n.cssHooks.pageXOffset = {
		get: (e, _o, _t) => {
			var r = n.data(e, "__nicescroll") || !1;
			return r?.ishwscroll ? r.getScrollLeft() : S.call(e);
		},
		set: function (e, o) {
			var t = n.data(e, "__nicescroll") || !1;
			return (
				t?.ishwscroll ? t.setScrollLeft(parseInt(o, 10)) : S.call(e, o), this
			);
		},
	}),
		(e.fn.scrollLeft = function (e) {
			if (void 0 === e) {
				var o = !!this[0] && (n.data(this[0], "__nicescroll") || !1);
				return o?.ishwscroll ? o.getScrollLeft() : S.call(this);
			}
			return this.each(function () {
				var o = n.data(this, "__nicescroll") || !1;
				o?.ishwscroll ? o.setScrollLeft(parseInt(e, 10)) : S.call(n(this), e);
			});
		});
	var z = function (e) {
		if (
			...
			(this.each = (e) => (n.each(this, e), this)),
			(this.push = (e) => {
	...
	!((e, o, t) => {
		...
		((e.expr.pseudos || e.expr[":"]).nicescroll = (e) =>
			void 0 !== n.data(e, "__nicescroll")),
