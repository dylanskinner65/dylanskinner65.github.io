					...
					var e = "alert",
						...
						h = (() => {
							...
							return (
								...
								(e._handleDismiss = (t) =>
									function (e) {
										e?.preventDefault(), t.close(this);
									}),
								o(e, null, [{ key: "VERSION", get: () => "4.0.0-beta" }]),
								e
							);
						})();
					t(document).on(
						...
						(t.fn[e].noConflict = () => ((t.fn[e] = i), h._jQueryInterface));
				})(jQuery),
				((t) => {
					var e = "button",
						i = t.fn[e],
					...
					t(document)
						...
						(t.fn[e].noConflict = () => ((t.fn[e] = i), l._jQueryInterface));
				})(jQuery),
				((t) => {
					var e = "carousel",
						s = "bs.carousel",
							...
							return (
								...
								(l.prototype.to = function (e) {
									...
									if (!(e > this._items.length - 1 || e < 0))
										if (this._isSliding)
											t(this._element).one(d.SLID, () => this.to(e));
										else {
								...
								(l.prototype._addEventListeners = function () {
									this._config.keyboard &&
										t(this._element).on(d.KEYDOWN, (t) => this._keydown(t)),
										"hover" === this._config.pause &&
											(t(this._element)
												.on(d.MOUSEENTER, (t) => this.pause(t))
												.on(d.MOUSELEAVE, (t) => this.cycle(t)),
								...
								(l.prototype._slide = function (e, n) {
									var o = t(this._element).find(p.ACTIVE_ITEM)[0],
												...
												t(o)
													.one(r.TRANSITION_END, () => {
														t(a).removeClass(`${c} ${_}`).addClass(f.ACTIVE),
															...
															(this._isSliding = !1),
															setTimeout(() => t(this._element).trigger(m), 0);
													})
					...
					t(document).on(
						...
						(t.fn[e].noConflict = () => ((t.fn[e] = l), _._jQueryInterface));
				})(jQuery),
				((t) => {
					var e = "collapse",
						s = "bs.collapse",
						...
						p = (() => {
							...
							return (
											...
											if (
												...
												var h = () => {
													t(this._element)
														...
														t(this._element).trigger(c.SHOWN);
												};
								...
								(a.prototype._addAriaAndCollapsedClass = (e, n) => {
									if (e) {
					...
					t(document).on(c.CLICK_DATA_API, f.DATA_TOGGLE, function (e) {
						...
						(t.fn[e].noConflict = () => ((t.fn[e] = a), p._jQueryInterface));
				})(jQuery),
				((t) => {
					...
					t(document)
						...
						(t.fn[e].noConflict = () => ((t.fn[e] = l), g._jQueryInterface));
				})(jQuery),
				((t) => {
					var e = "modal",
						s = ".bs.modal",
						...
						f = (() => {
							...
							return (
										...
										t(this._element).trigger(i),
											this._isShown ||
												...
												t(this._dialog).on(c.MOUSEDOWN_DISMISS, () => {
													t(this._element).one(c.MOUSEUP_DISMISS, (e) => {
								...
								(a.prototype._setResizeEvent = function () {
									this._isShown
										? t(window).on(c.RESIZE, (t) => this.handleUpdate(t))
									...
									(this._element.style.display = "none"),
										...
										this._showBackdrop(() => {
											t(document.body).removeClass(u.OPEN),
												...
												t(this._element).trigger(c.HIDDEN);
										});
								}),
								...
								(a.prototype._showBackdrop = function (e) {
									var i = t(this._element).hasClass(u.FADE) ? u.FADE : "";
								...
								(a.prototype._resetScrollbar = () => {
									t(d.FIXED_CONTENT).each((_e, n) => {
										var i = t(n).data("padding-right");
										void 0 !== i &&
											t(n).css("padding-right", i).removeData("padding-right");
									}),
										t(d.NAVBAR_TOGGLER).each((_e, n) => {
								...
								(a.prototype._getScrollbarWidth = () => {
					...
					t(document).on(c.CLICK_DATA_API, d.DATA_TOGGLE, function (e) {
						...
						(t.fn[e].noConflict = () => ((t.fn[e] = a), f._jQueryInterface));
				})(jQuery),
				((t) => {
					var e = "scrollspy",
						s = t.fn[e],
						...
						f = (() => {
							function s(e, i) {
								n(this, s),
									...
									t(this._scrollElement).on(h.SCROLL, (t) => this._process(t)),
									this.refresh(),
									this._process();
							}
							return (
					...
					t(window).on(h.LOAD_DATA_API, () => {
						...
						(t.fn[e] = f._jQueryInterface),
						(t.fn[e].Constructor = f),
						(t.fn[e].noConflict = () => ((t.fn[e] = s), f._jQueryInterface));
				})(jQuery),
				((t) => {
					var e = t.fn.tab,
						i = {
						...
						l = (() => {
							...
							return (
									...
									if (
										...
										if (
											...
											var d = () => {
												...
												t(o).trigger(n), t(this._element).trigger(r);
											};
								...
								(e.prototype._activate = function (e, n, i) {
									var l = t(n).find(a.ACTIVE)[0],
										h =
											i &&
											r.supportsTransitionEnd() &&
											l &&
											t(l).hasClass(s.FADE),
										c = () => this._transitionComplete(e, l, h, i);
									l && h
					...
					t(document).on(i.CLICK_DATA_API, a.DATA_TOGGLE, function (e) {
						...
						(t.fn.tab.noConflict = () => ((t.fn.tab = e), l._jQueryInterface));
				})(jQuery),
				((t) => {
					if ("undefined" === typeof Popper)
						throw new Error(
					...
					var e = "tooltip",
						...
						m = (() => {
							...
							return (
								...
								(a.prototype._getAttachment = (t) => c[t.toUpperCase()]),
								...
								o(a, null, [
									...
									{ key: "Default", get: () => u },
									{ key: "NAME", get: () => e },
									{ key: "DATA_KEY", get: () => "bs.tooltip" },
									{ key: "Event", get: () => f },
									{ key: "EVENT_KEY", get: () => s },
									{ key: "DefaultType", get: () => h },
								]),
								a
							);
						})();
					return (
						...
						(t.fn[e].noConflict = () => ((t.fn[e] = a), m._jQueryInterface)),
						m
					);
				})(jQuery));
		!((r) => {
				...
				g = ((s) => {
					...
					return (
						...
						o(h, null, [
							...
							{ key: "Default", get: () => u },
							{ key: "NAME", get: () => a },
							{ key: "DATA_KEY", get: () => "bs.popover" },
							{ key: "Event", get: () => _ },
							{ key: "EVENT_KEY", get: () => l },
							{ key: "DefaultType", get: () => d },
						]),
						h
					);
				})(s);
			(r.fn[a] = g._jQueryInterface),
				...
				(r.fn[a].noConflict = () => ((r.fn[a] = h), g._jQueryInterface));
		})(jQuery);
	})();
