...
<figure class="flex flex-col items-center my-8">
    <img src="/projects_files/causal_inference/visualized_graph.webp" alt="A visualized graph." class="w-full max-w-3xl h-auto rounded-none shadow-2xl border border-foreground/5" />
