	...
	return (
		((a, b) => {
			...
			(b.namespaces = {
				...
				(b.noop = (a) => a),
				(b.alphaNumerate = (a) => String.fromCharCode(97 + (a % 26))),
				(b.extend = function (a) {
					var c, d, e;
				...
				(b.replaceAll = (a, b, c) => a.replace(new RegExp(b, "g"), c)),
				(b.ensureUnit = (a, b) => ("number" === typeof a && (a += b), a)),
				(b.quantity = (a) => {
					if ("string" === typeof a) {
						var b = /^(\d+)\s*(.*)$/g.exec(a);
				...
				(b.querySelector = (a) => (a instanceof Node ? a : d.querySelector(a))),
				(b.times = (a) => Array.apply(null, new Array(a))),
				(b.sum = (a, b) => a + (b ? b : 0)),
				(b.mapMultiply = (a) => (b) => b * a),
				(b.mapAdd = (a) => (b) => b + a),
				(b.serialMap = (a, c) => {
					var d = [],
						e = Math.max.apply(
				...
				(b.roundWithPrecision = (a, c) => {
					var d = 10 ** (c || b.precision);
				...
				(b.serialize = (a) =>
					null === a || void 0 === a
						...
						: ("number" === typeof a
							...
							Object.keys(b.escapingMap).reduce(
								(a, c) => b.replaceAll(a, c, b.escapingMap[c]),
								a,
							))),
				(b.deserialize = (a) => {
					if ("string" !== typeof a) return a;
					a = Object.keys(b.escapingMap).reduce(
						(a, c) => b.replaceAll(a, b.escapingMap[c], c),
						a,
					);
					try {
				...
				(b.createSvg = (a, c, d, e) => {
					...
					return (
						...
						Array.prototype.slice
							...
							.filter((a) => a.getAttributeNS(b.namespaces.xmlns, "ct"))
							.forEach((b) => {
								a.removeChild(b);
							}),
				...
				(b.normalizeData = (a, c, d) => {
					...
					return (
						...
						(e = f.normalized.series.every((a) => Array.isArray(a))
							? Math.max.apply(
									null,
									f.normalized.series.map((a) => a.length),
								)
				...
				(b.safeHasProperty = (a, b) =>
					null !== a && "object" === typeof a && Object.hasOwn(a, b)),
				(b.isDataHoleValue = (a) =>
					null === a ||
					void 0 === a ||
				...
				(b.reverseData = (a) => {
					...
					for (var b = 0; b < a.series.length; b++)
						"object" === typeof a.series[b] && void 0 !== a.series[b].data
							...
							: Array.isArray(a.series[b]) && a.series[b].reverse();
				}),
				(b.getDataArray = (a, _c, d) => {
					function e(a) {
						...
						if (!b.isDataHoleValue(a)) {
							if (d) {
								...
								return (
									...
									(c.x = Object.hasOwn(a, "x")
										? b.getNumberOrUndefined(a.x)
										: c.x),
									(c.y = Object.hasOwn(a, "y")
				...
				(b.orderOfMagnitude = (a) =>
					Math.floor(Math.log(Math.abs(a)) / Math.LN10)),
				(b.projectLength = (a, b, c) => (b / c.range) * a),
				(b.getAvailableHeight = (a, c) =>
					Math.max(
				...
				(b.getHighLow = (a, c, d) => {
					function e(a) {
						if (void 0 !== a)
							if (Array.isArray(a)) for (var b = 0; b < a.length; b++) e(a[b]);
							else {
								var c = d ? +a[d] : +a;
				...
				(b.isNumeric = (a) => null !== a && Number.isFinite(a)),
				(b.isFalseyButZero = (a) => !a && 0 !== a),
				(b.getNumberOrUndefined = (a) => (b.isNumeric(a) ? +a : void 0)),
				(b.isMultiValue = (a) =>
				...
				(b.createGridBackground = (a, b, c, d) => {
					var e = a.elem(
						"rect",
				...
				(b.createLabel = (a, c, e, f, g, h, i, j, k, l, m) => {
					var n,
						o = {};
					if (
				...
				(b.getSeriesOption = (a, b, c) => {
					if (a.name && b.series && b.series[a.name]) {
						var d = b.series[a.name];
						return Object.hasOwn(d, c) ? d[c] : b[c];
					}
					return b[c];
				}),
				(b.optionsProvider = (a, d, e) => {
					function f(a) {
						var f = h;
						if (((h = b.extend({}, j)), d))
					...
					return (
						f(),
						{
							...
							getCurrentOptions: () => b.extend({}, h),
						}
					);
				}),
				(b.splitIntoSegments = (a, c, d) => {
		...
		((_a, b) => {
			(b.Interpolation = {}),
				...
				(b.Interpolation.monotoneCubic = (a) => {
					var c = { fillHoles: !1 };
					return (
						(a = b.extend({}, c, a)),
						function d(c, e) {
		...
		((_a, b) => {
			...
			function e() {
				var a = c(arguments),
					b = a[0];
				return (
					a.splice(1, a.length - 1).forEach((a) => {
			...
			function g() {
				i.addEventListener("resize", this.resizeListener),
					...
					this.options.plugins?.forEach(
						function (a) {
							Array.isArray(a) ? a[0](this, a[1]) : a(this);
						}.bind(this),
					),
		...
		((_a, b) => {
			...
			function d(a, b) {
				a.forEach((c, d) => {
					t[c.command.toLowerCase()].forEach((e, f) => {
						b(c, e, d, f, a);
					});
				});
			}
			...
			function m() {
				var a = 10 ** this.options.accuracy;
				return (
					...
					c.raw.series.forEach(
						function (e, g) {
							...
							if (m.showArea && f.range) {
								...
								o.splitByCommand("M")
									.filter((a) => a.pathElements.length > 1)
									.map((a) => {
			...
			function c(a) {
				...
				a.distributeSeries
					? ((c = b.normalizeData(
						...
						(c.normalized.series = c.normalized.series.map((a) => [a])))
					: (c = b.normalizeData(
							this.data,
							a.reverseData,
							a.horizontalBars ? "x" : "y",
				...
				if (a.stackBars && 0 !== c.normalized.series.length) {
					var i = b.serialMap(c.normalized.series, function () {
						return Array.prototype.slice
							.call(arguments)
							.map((a) => a)
							.reduce((a, b) => ({ x: a.x + b?.x || 0, y: a.y + b?.y || 0 }), {
								x: 0,
								y: 0,
							});
					});
		...
		((a, b) => {
			...
			function d(a) {
				...
				(this.svg = b.createSvg(
					...
					(i = a.total || j.normalized.series.reduce((a, b) => a + b, 0));
				...
				var n = { x: e.x1 + e.width() / 2, y: e.y2 + e.height() / 2 },
					o =
						1 ===
						j.raw.series.filter((a) =>
							Object.hasOwn(a, "value") ? 0 !== a.value : 0 !== a,
						).length;
